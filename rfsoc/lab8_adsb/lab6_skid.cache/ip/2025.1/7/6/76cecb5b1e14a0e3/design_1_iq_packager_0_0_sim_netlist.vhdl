...
\valid_counter[15]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
        ...
        port map (
      I0 => valid_counter_reg(13),
      I1 => valid_counter_reg(14),
      I2 => valid_counter_reg(11),
      I3 => valid_counter_reg(12),
      I4 => m00_axis_tready,
      I5 => valid_counter_reg(15),
      O => \valid_counter[15]_i_2_n_0\
    );
\valid_counter[15]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
\valid_counter[15]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
        ...
        port map (
      I0 => valid_counter_reg(7),
      I1 => valid_counter_reg(8),
      I2 => valid_counter_reg(5),
      I3 => valid_counter_reg(6),
      I4 => valid_counter_reg(10),
      I5 => valid_counter_reg(9),
