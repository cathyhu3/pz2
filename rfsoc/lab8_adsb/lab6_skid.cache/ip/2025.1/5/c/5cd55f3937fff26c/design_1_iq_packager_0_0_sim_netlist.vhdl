...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_iq_packager is
  port (
    ...
    s01_axis_tdata : in STD_LOGIC_VECTOR ( 12 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_iq_packager is
  ...
  signal \s_counter[15]_i_2_n_0\ : STD_LOGIC;
  signal \s_counter[15]_i_3_n_0\ : STD_LOGIC;
  signal \s_counter[15]_i_4_n_0\ : STD_LOGIC;
  signal \s_counter[15]_i_5_n_0\ : STD_LOGIC;
  signal s_counter_reg : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal \NLW_s_counter0_carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 6 );
  signal \NLW_s_counter0_carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 to 7 );
  ...
  attribute SOFT_HLUTNM of \s_counter[15]_i_3\ : label is "soft_lutpair0";
begin
...
s_counter0_carry: unisim.vcomponents.CARRY8
     port map (
      CI => s_counter_reg(0),
      CI_TOP => '0',
      CO(7) => s_counter0_carry_n_0,
      CO(6) => s_counter0_carry_n_1,
      CO(5) => s_counter0_carry_n_2,
      CO(4) => s_counter0_carry_n_3,
      CO(3) => s_counter0_carry_n_4,
      CO(2) => s_counter0_carry_n_5,
      CO(1) => s_counter0_carry_n_6,
      CO(0) => s_counter0_carry_n_7,
      DI(7 downto 0) => B"00000000",
      O(7 downto 0) => p_0_in(8 downto 1),
      S(7 downto 0) => s_counter_reg(8 downto 1)
    );
\s_counter0_carry__0\: unisim.vcomponents.CARRY8
     port map (
      CI => s_counter0_carry_n_0,
      CI_TOP => '0',
      CO(7 downto 6) => \NLW_s_counter0_carry__0_CO_UNCONNECTED\(7 downto 6),
      CO(5) => \s_counter0_carry__0_n_2\,
      CO(4) => \s_counter0_carry__0_n_3\,
      CO(3) => \s_counter0_carry__0_n_4\,
      CO(2) => \s_counter0_carry__0_n_5\,
      CO(1) => \s_counter0_carry__0_n_6\,
      CO(0) => \s_counter0_carry__0_n_7\,
      DI(7 downto 0) => B"00000000",
      O(7) => \NLW_s_counter0_carry__0_O_UNCONNECTED\(7),
      O(6 downto 0) => p_0_in(15 downto 9),
      S(7) => '0',
      S(6 downto 0) => s_counter_reg(15 downto 9)
    );
...
\s_counter[15]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"80000000FFFFFFFF"
        ...
        port map (
      I0 => \s_counter[15]_i_3_n_0\,
      I1 => s_counter_reg(5),
      I2 => s_counter_reg(4),
      I3 => \s_counter[15]_i_4_n_0\,
      I4 => \s_counter[15]_i_5_n_0\,
      I5 => s00_axis_aresetn,
      O => \s_counter[15]_i_1_n_0\
    );
\s_counter[15]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => m00_axis_tready,
      I1 => s00_axis_tvalid,
      O => \s_counter[15]_i_2_n_0\
    );
\s_counter[15]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\s_counter[15]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
    )
        port map (
      ...
      I4 => s00_axis_tvalid,
      I5 => m00_axis_tready,
      O => \s_counter[15]_i_4_n_0\
    );
\s_counter[15]_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
    )
        port map (
      ...
      I4 => s_counter_reg(11),
      I5 => s_counter_reg(10),
      O => \s_counter[15]_i_5_n_0\
    );
\s_counter_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => \s_counter[15]_i_2_n_0\,
      D => p_0_in(0),
      Q => s_counter_reg(0),
      R => \s_counter[15]_i_1_n_0\
    );
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_iq_packager
     port map (
      control(3 downto 0) => \^control\(3 downto 0),
      m00_axis_tdata(28 downto 16) => m00_axis_tdata(31 downto 19),
      ...
      s00_axis_tvalid => \^s00_axis_tvalid\,
      s01_axis_tdata(12 downto 0) => s01_axis_tdata(15 downto 3)
    );
