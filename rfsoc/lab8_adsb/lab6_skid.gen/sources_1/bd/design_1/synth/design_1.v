...
module design_1
  ...
  wire adc2_clk_clk_n;
  wire adc2_clk_clk_p;
  wire [127:0]adsb_0_M00_AXIS_TDATA;
  wire adsb_0_M00_AXIS_TLAST;
  wire adsb_0_M00_AXIS_TREADY;
  wire [15:0]adsb_0_M00_AXIS_TSTRB;
  wire adsb_0_M00_AXIS_TVALID;
  ...
  wire [31:0]iq_packager_0_M00_AXIS_TDATA;
  wire iq_packager_0_M00_AXIS_TLAST;
  wire iq_packager_0_M00_AXIS_TREADY;
  wire [3:0]iq_packager_0_M00_AXIS_TSTRB;
  wire iq_packager_0_M00_AXIS_TVALID;
  wire [3:0]led;
  ...
  design_1_adsb_0_0 adsb_0
       (.m00_axis_aclk(clk_wiz_0_clk_out1),
        .m00_axis_aresetn(proc_sys_reset_1_peripheral_aresetn),
        .m00_axis_tdata(adsb_0_M00_AXIS_TDATA),
        .m00_axis_tlast(adsb_0_M00_AXIS_TLAST),
        .m00_axis_tready(adsb_0_M00_AXIS_TREADY),
        .m00_axis_tstrb(adsb_0_M00_AXIS_TSTRB),
        .m00_axis_tvalid(adsb_0_M00_AXIS_TVALID),
        .s00_axis_aclk(clk_wiz_0_clk_out1),
        .s00_axis_aresetn(proc_sys_reset_1_peripheral_aresetn),
        .s00_axis_tdata(iq_packager_0_M00_AXIS_TDATA),
        .s00_axis_tlast(iq_packager_0_M00_AXIS_TLAST),
        .s00_axis_tready(iq_packager_0_M00_AXIS_TREADY),
        .s00_axis_tstrb(iq_packager_0_M00_AXIS_TSTRB),
        .s00_axis_tvalid(iq_packager_0_M00_AXIS_TVALID));
  ...
  design_1_axis_data_fifo_0_0 axis_data_fifo_0
       (.m_axis_aclk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .s_axis_tdata(adsb_0_M00_AXIS_TDATA),
        .s_axis_tlast(adsb_0_M00_AXIS_TLAST),
        .s_axis_tready(adsb_0_M00_AXIS_TREADY),
        .s_axis_tstrb(adsb_0_M00_AXIS_TSTRB),
        .s_axis_tvalid(adsb_0_M00_AXIS_TVALID));
  design_1_iq_packager_0_0 iq_packager_0
       (.control(sw),
        .leds(led),
        .m00_axis_aclk(clk_wiz_0_clk_out1),
        .m00_axis_aresetn(proc_sys_reset_1_peripheral_aresetn),
        .m00_axis_tdata(iq_packager_0_M00_AXIS_TDATA),
        .m00_axis_tlast(iq_packager_0_M00_AXIS_TLAST),
        .m00_axis_tready(iq_packager_0_M00_AXIS_TREADY),
        .m00_axis_tstrb(iq_packager_0_M00_AXIS_TSTRB),
        .m00_axis_tvalid(iq_packager_0_M00_AXIS_TVALID),
        .s00_axis_aclk(clk_wiz_0_clk_out1),
        .s00_axis_aresetn(proc_sys_reset_1_peripheral_aresetn),
