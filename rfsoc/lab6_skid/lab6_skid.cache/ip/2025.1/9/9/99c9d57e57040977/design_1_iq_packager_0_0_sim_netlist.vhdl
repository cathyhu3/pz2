...
m00_axis_tlast_INST_0: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
m00_axis_tlast_INST_0_i_3: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
    )
        port map (
...
\s_counter[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \s_counter[0]_i_5_n_0\,
      I4 => \s_counter[0]_i_6_n_0\,
      I5 => s00_axis_aresetn,
...
\s_counter[0]_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
    )
        port map (
...
\s_counter[0]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
    )
        port map (
...
\s_counter[0]_i_7\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\valid_counter[15]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => valid_counter_reg(3),
      I2 => valid_counter_reg(0),
      I3 => valid_counter_reg(1),
      I4 => valid_counter_reg(5),
      I5 => valid_counter_reg(4),
      O => \valid_counter[15]_i_2_n_0\
    );
\valid_counter[15]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
    )
        port map (
      I0 => valid_counter_reg(14),
      I1 => valid_counter_reg(15),
      I2 => valid_counter_reg(12),
      I3 => valid_counter_reg(13),
      I4 => s00_axis_tvalid,
      I5 => m00_axis_tready,
...
\valid_counter[15]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
        ...
        port map (
      I0 => valid_counter_reg(8),
      I1 => valid_counter_reg(9),
      I2 => valid_counter_reg(6),
      I3 => valid_counter_reg(7),
      I4 => valid_counter_reg(11),
      I5 => valid_counter_reg(10),
