...
module design_1
  ...
  design_1_axis_data_fifo_0_0 axis_data_fifo_0
       (.m_axis_aclk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .s_axis_tdata(iq_packager_0_M00_AXIS_TDATA),
        .s_axis_tlast(iq_packager_0_M00_AXIS_TLAST),
        .s_axis_tready(iq_packager_0_M00_AXIS_TREADY),
        .s_axis_tstrb(iq_packager_0_M00_AXIS_TSTRB),
        .s_axis_tvalid(iq_packager_0_M00_AXIS_TVALID));
