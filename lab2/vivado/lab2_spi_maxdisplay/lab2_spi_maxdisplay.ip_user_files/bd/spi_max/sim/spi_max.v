...
//Date        : Thu Sep 18 15:21:44 2025
//Host        : eecs-digital-40 running 64-bit Ubuntu 24.04.3 LTS
//Command     : generate_target spi_max.bd
//Design      : spi_max
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "spi_max,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=spi_max,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_clkrst_cnt=1,da_ps7_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "spi_max.hwdef" *) 
module spi_max
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire data;
  wire dclk;
  wire [63:0]disp_interface_0_command;
  wire disp_interface_0_trigger;
  wire [3:0]leds;
  ...
  spi_max_disp_interface_0_0 disp_interface_0
       (.btns(btns),
        .command(disp_interface_0_command),
        ...
        .trigger(disp_interface_0_trigger));
  assign leds = disp_interface_0_command[3:0];
  spi_max_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
  ...
  spi_max_rst_ps7_0_100M_0 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  spi_max_spi_tx_w_0_0 spi_tx_w_0
       (.clk(processing_system7_0_FCLK_CLK0),
        .copi(data),
        .cs(cs),
        .data_in(disp_interface_0_command),
        .dclk(dclk),
