...
HD_PWD='/home/cathyhu3/s965/pz2/lab2_spi_maxdisplay/lab2_spi_maxdisplay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_max_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_max_wrapper.tcl -notrace
