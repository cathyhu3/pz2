...
HD_PWD='/home/cathyhu3/s965/pz2/lab2_spi_maxdisplay/lab2_spi_maxdisplay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_max_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_max_wrapper.tcl
